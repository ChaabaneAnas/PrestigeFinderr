...
const Footer = () => {
  return (
    <>
      ...
      <footer className="px-6 py-4 w-full bg-black text-slate-400	 text-xs font-extralight text-center md:px-16  md:text-left">
        All Copyrights Reserved to Exa Capital
      </footer>
    </>
  );
};
